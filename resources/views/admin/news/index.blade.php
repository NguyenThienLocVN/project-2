    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav class="d-flex justify-content-between">
                ...
                <div class="d-flex">
                    <a href="{{ route('admin.news.create') }}" class="btn btn-outline-primary me-1">Tạo mới</a>
                    <button class="btn btn-outline-danger" id="selected-news-delete" type="button">Xoá</button>
