                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" method="POST" action="{{ route('admin.news.update', $news->id) }}"
                                ...
                                <div class="col-md-4">
                                    <label for="inputEmail5" class="form-label">Ảnh nổi bật</label>
                                ...
                                <div class="col-md-4">
                                    <label for="multiple select" class="form-label">Danh mục</label>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select id="inputState" class="form-select" name="is_published">
                                        <option @if ($news->is_published) selected=true @endif value="1">
                                            Đăng bài</option>
                                        <option @if (!$news->is_published) selected = true @endif value="0">Lưu bản nháp</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <label for="inputState" class="form-label">Tuỳ chọn</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" rows="3" class="form-control" id="excerpt" name="excerpt">{{ $news->excerpt }}</textarea>
                                    @error('excerpt')
                                        <div class="text-danger">*{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div id="quill_editor" style="height: 250px !important">
                                        {!! $news->description !!}
                                    </div>
                                    @error('description')
                                        <div class="text-danger">*{{ $message }}</div>
                                ...
                                <div class="col-md-12" style="margin-top: 60px;">
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-outline-success px-5">Cập nhật</button>
                                    </div>
                                </div>
