                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.news.index') }}" class="btn btn-outline-primary">Danh sách bài viết</a>
                        </div>
                        <div class="card-body">
                            <!-- Multi Columns Form -->
                            <form class="row g-3" method="POST" action="{{ route('admin.news.store') }}"
                                ...
                                @csrf
                                <div class="col-md-12">
                                    <label for="inputName5" class="form-label">Tiêu đề (<span
                                ...
                                <div class="col-md-4">
                                    <label for="inputEmail5" class="form-label">Ảnh nổi bật (<span
                                            class="text-danger">*</span>)</label>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Chọn ảnh nổi bật
                                                    </h1>
                                ...
                                <div class="col-md-4">
                                    <label for="multiple select" class="form-label">Danh mục (<span
                                            class="text-danger">*</span>)</label>
                                ...
                                <div class="col-md-2">
                                    <label for="inputState" class="form-label">Trạng thái (<span
                                            class="text-danger">*</span>)</label>
                                    <select id="inputState" class="form-select" name="is_published">
                                        <option selected=true value="1">Đăng bài</option>
                                        <option value="2">Lưu bản nháp</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <label for="inputState" class="form-label">Tuỳ chọn (<span
                                            class="text-danger">*</span>)</label>
                                    <select id="inputState" class="form-select" name="is_trending_news">
                                        <option selected=true value="1">Tin nổi bật</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" rows="3" class="form-control" id="excerpt" name="excerpt">{{ old('excerpt') }}</textarea>
                                    @error('excerpt')
                                        <div class="text-danger">*{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <label for="multiple select" class="form-label">Nội dung</label>
                                    <textarea name="description" id="description" class="d-none"></textarea>
                                    <div id="quill_editor" style="height: 250px;">
                                        {!! old('description') !!}
                                    </div>
                                    @error('description')
                                        <div class="text-danger">*{{ $message }}</div>
                                ...
                                <div class="col-md-12" style="margin-top: 60px;">
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-outline-success px-5">Tạo mới</button>
                                    </div>
                                </div>
